...
+ isConnected(24,'alarm_1', 'IoT_subnet_1')


## collab_1 ##
#  collab_sysuser1_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(25,'collab_sysuser1_1', 'collab_1', 'None', 'user')
#  collab_http_1 (sdl.nodes.Software.Server.HTTP.Linux.Nginx),listeningOn
+ listeningOn(26,'collab_1', 'tcp', '80')
#  collab_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(27,'collab_1', 'DMZ_subnet_1')
#  collab_root_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(28,'collab_root_1', 'collab_1', 'None', 'admin')


## ids_1 ##
#  ids_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(29,'ids_1', 'Server_subnet_1')


## dc_1 ##
#  dc_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(30,'dc_1', 'Server_subnet_1')


## intranet_1 ##
#  intranet_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(31,'intranet_1', 'Server_subnet_1')


## www_1 ##
#  www_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(32,'www_1', 'DMZ_subnet_1')
#  www_vuln1_1 (sdl.nodes.Vulnerability.Server.HTTP.Linux.Apache.OpenProxy),hostACL
hostACL(33,K, H, 'http', P) <= listeningOn(ID1,'www_1', 'tcp', '80') & hostACL(ID2,K, 'www_1', 'tcp', '80') & listeningOn(ID3,H, 'http', P) & hostACL(ID4,'www_1', H, 'http', P)
#  www_http_1 (sdl.nodes.Software.Server.HTTP.Linux.Apache),listeningOn
+ listeningOn(34,'www_1', 'tcp', '80')
#  www_sysuser1_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(35,'www_sysuser1_1', 'www_1', 'None', 'user')
#  www_root_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(36,'www_root_1', 'www_1', 'None', 'admin')
#  www_ssh_1 (sdl.nodes.Software.Server.SSH.Linux.OpenSSH),listeningOn
+ listeningOn(37,'www_1', 'tcp', '22')
#  www_user1_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(38,'www_user1_1', 'www_1', '9JmDGEr4', 'user')
#  www_cms_1 (sdl.nodes.Software.Server.CMS.Linux.Wordpress),knows2
knows(39,A, 'venerus') <= hasUser(ID1,'www_sysuser1_1','www_1',P, R) & hasAccount(ID2,A,'www_1', 'www_sysuser1_1')
#  www_cms_1 (sdl.nodes.Software.Server.CMS.Linux.Wordpress),knows1
knows(40,A, 'venerus') <= hasUser(ID1,U,'www_1',P,'admin') & hasAccount(ID2,A,'www_1',U)


## hmi_1 ##
#  hmi_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(41,'hmi_1', 'IoT_subnet_1')


## cam3_1 ##
#  cam3_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(42,'cam3_1', 'Server_subnet_1')


## db_1 ##
#  db_cmsdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows2
knows(43,A, 'CMS') <= hasUser(ID1,U,'db_1',P,'admin') & hasAccount(ID2,A,'db_1',U)
#  db_cmsdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows1
knows(44,A, 'CMS') <= knows(ID1,A, 'venerus') & hasAccount(ID2,A,H,U) & hostACL(ID3,H, 'db_1', 'tcp', '3306')
#  db_webmin_1 (sdl.nodes.Software.Server.Linux.Webmin),listeningOn
+ listeningOn(45,'db_1', 'http', '10000')
...
#  db_vuln1_1 (sdl.nodes.Vulnerability.Linux.Webmin.CVE_2019_15107),hasAccount
hasAccount(50,A, 'db_1', 'db_root_1') <= hasUser(ID1,'db_root_1', 'db_1', P, R) & listeningOn(ID2,'db_1', 'http', '10000') & hostACL(ID3,K, 'db_1', 'http', '10000') & hasAccount(ID4,A, K, V)
#  db_collabdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows2
knows(51,A, 'nextcloud') <= hasUser(ID1,U,'db_1',P,'admin') & hasAccount(ID2,A,'db_1',U)
#  db_collabdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows1
knows(52,A, 'nextcloud') <= knows(ID1,A, 'venerus') & hasAccount(ID2,A,H,U) & hostACL(ID3,H, 'db_1', 'tcp', '3306')
#  db_root_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(53,'db_root_1', 'db_1', 'None', 'admin')


## elev_1 ##
#  elev_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(54,'elev_1', 'IoT_subnet_1')


## cam4_1 ##
#  cam4_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(55,'cam4_1', 'Server_subnet_1')


## client_1 ##
#  eve_1 (sdl.nodes.Principal),hasAccount
+ hasAccount(56,'eve_1', 'client_1','client_user1_1')
#  client_user1_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(57,'client_user1_1', 'client_1', 'supersecret', 'admin')
#  client_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(58,'client_1', 'Simint1_subnet_1')


## Provider_1 ##
#  Provider_Route1_1 (sdl.nodes.Configuration.Route.Firewall.VyOS),existsRoute
+ existsRoute(59,'Outside_subnet_1', 'DMZ_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Extnet_subnet_1','Extnet_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Extnet_subnet_1','Outside_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Extnet_subnet_1','Simint1_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Outside_subnet_1','Extnet_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Outside_subnet_1','Outside_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Outside_subnet_1','Simint1_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Simint1_subnet_1','Extnet_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Simint1_subnet_1','Outside_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(60,'Simint1_subnet_1','Simint1_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isConnected
+ isConnected(61,'Provider_1', 'Extnet_subnet_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isConnected
+ isConnected(61,'Provider_1', 'Outside_subnet_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isConnected
+ isConnected(61,'Provider_1', 'Simint1_subnet_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isRouter
+ isRouter(62,'Provider_1')


## cam2_1 ##
#  cam2_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(63,'cam2_1', 'Server_subnet_1')

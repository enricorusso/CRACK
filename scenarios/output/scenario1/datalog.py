...
knows(34,A, 'alice') <= listeningOn(ID1,'www_1', 'tcp', '80') & hostACL(ID2,K, 'www_1', 'tcp', '80') & hasAccount(ID3,A, K, V)
#  www_vuln2_1 (sdl.nodes.Vulnerability.Linux.User.RemoteWeakPassword),hasAccount
hasAccount(35,A, 'www_1', 'www_user1_1') <= knows(ID1,A, 'alice') & hasUser(ID2,'www_user1_1', 'www_1', P, R) & listeningOn(ID3,'www_1', 'tcp', '22') & hostACL(ID4,K, 'www_1', 'tcp', '22') & hasAccount(ID5,A, K, V)
#  www_vuln1_1 (sdl.nodes.Vulnerability.Linux.EOP.APT),hasAccount
hasAccount(36,A, 'www_1', 'www_root_1') <= hasUser(ID1,'www_root_1', 'www_1', P, R) & hasAccount(ID2,A, 'www_1', 'www_user1_1')
#  www_http_1 (sdl.nodes.Software.Server.HTTP.Linux.Apache),listeningOn
+ listeningOn(37,'www_1', 'tcp', '80')
#  www_sysuser1_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(38,'www_sysuser1_1', 'www_1', 'None', 'user')
#  www_root_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(39,'www_root_1', 'www_1', 'None', 'admin')
#  www_ssh_1 (sdl.nodes.Software.Server.SSH.Linux.OpenSSH),listeningOn
+ listeningOn(40,'www_1', 'tcp', '22')
#  www_user1_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(41,'www_user1_1', 'www_1', '9JmDGEr4', 'user')
#  www_cms_1 (sdl.nodes.Software.Server.CMS.Linux.Wordpress),knows2
knows(42,A, 'venerus') <= hasUser(ID1,'www_sysuser1_1','www_1',P, R) & hasAccount(ID2,A,'www_1', 'www_sysuser1_1')
#  www_cms_1 (sdl.nodes.Software.Server.CMS.Linux.Wordpress),knows1
knows(43,A, 'venerus') <= hasUser(ID1,U,'www_1',P,'admin') & hasAccount(ID2,A,'www_1',U)


## hmi_1 ##
#  hmi_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(44,'hmi_1', 'IoT_subnet_1')


## cam3_1 ##
#  cam3_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(45,'cam3_1', 'Server_subnet_1')


## db_1 ##
#  db_cmsdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows2
knows(46,A, 'CMS') <= hasUser(ID1,U,'db_1',P,'admin') & hasAccount(ID2,A,'db_1',U)
#  db_cmsdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows1
knows(47,A, 'CMS') <= knows(ID1,A, 'venerus') & hasAccount(ID2,A,H,U) & hostACL(ID3,H, 'db_1', 'tcp', '3306')
#  db_confidentialdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows2
knows(48,A, 'DB_confidential') <= hasUser(ID1,U,'db_1',P,'admin') & hasAccount(ID2,A,'db_1',U)
#  db_confidentialdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows1
knows(49,A, 'DB_confidential') <= knows(ID1,A, 'venerus') & hasAccount(ID2,A,H,U) & hostACL(ID3,H, 'db_1', 'tcp', '3306')
#  db_config_1 (sdl.nodes.Configuration.DBMS.Linux.MySQL.RootAllHosts),listeningOn
+ listeningOn(50,'db_1', 'tcp', '3306')
#  db_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(51,'db_1', 'Server_subnet_1')
#  db_collabdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows2
knows(52,A, 'nextcloud') <= hasUser(ID1,U,'db_1',P,'admin') & hasAccount(ID2,A,'db_1',U)
#  db_collabdb_1 (sdl.nodes.Configuration.DB.Linux.MySQL),knows1
knows(53,A, 'nextcloud') <= knows(ID1,A, 'venerus') & hasAccount(ID2,A,H,U) & hostACL(ID3,H, 'db_1', 'tcp', '3306')
#  db_root_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(54,'db_root_1', 'db_1', 'None', 'admin')


## elev_1 ##
#  elev_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(55,'elev_1', 'IoT_subnet_1')


## cam4_1 ##
#  cam4_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(56,'cam4_1', 'Server_subnet_1')


## client_1 ##
#  eve_1 (sdl.nodes.Principal),hasAccount
+ hasAccount(57,'eve_1', 'client_1','client_user1_1')
#  client_user1_1 (sdl.nodes.User.Linux),hasUser
+ hasUser(58,'client_user1_1', 'client_1', 'supersecret', 'admin')
#  client_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(59,'client_1', 'Simint1_subnet_1')


## Provider_1 ##
#  Provider_Route1_1 (sdl.nodes.Configuration.Route.Firewall.VyOS),existsRoute
+ existsRoute(60,'Outside_subnet_1', 'DMZ_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Extnet_subnet_1','Extnet_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Extnet_subnet_1','Outside_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Extnet_subnet_1','Simint1_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Outside_subnet_1','Extnet_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Outside_subnet_1','Outside_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Outside_subnet_1','Simint1_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Simint1_subnet_1','Extnet_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Simint1_subnet_1','Outside_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),existsRoute
+ existsRoute(61,'Simint1_subnet_1','Simint1_subnet_1','Provider_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isConnected
+ isConnected(62,'Provider_1', 'Extnet_subnet_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isConnected
+ isConnected(62,'Provider_1', 'Outside_subnet_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isConnected
+ isConnected(62,'Provider_1', 'Simint1_subnet_1')
#  Provider_Firewall_1 (sdl.nodes.Firewall.VyOS),isRouter
+ isRouter(63,'Provider_1')


## cam2_1 ##
#  cam2_system_1 (sdl.nodes.System.Linux),isConnected
+ isConnected(64,'cam2_1', 'Server_subnet_1')

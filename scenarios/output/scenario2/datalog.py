...
hasAccount(34,A, 'www_1', 'www_root_1') <= hasUser(ID1,'www_root_1', 'www_1', P, R) & listeningOn(ID2,'www_1', 'tcp', '80') & hostACL(ID3,K, 'www_1', 'tcp', '80') & hasAccount(ID4,A, K, V)
...
knows(40,A, 'venerus') <= hasUser(ID1,'www_root_1','www_1',P, R) & hasAccount(ID2,A,'www_1', 'www_root_1')
